 ...
 * @deprecated Since 0.11.0 - use {@link com.helger.peppol.vida.tdd.v110.PeppolViDATDD110DocumentLineBuilder}
...
public class PeppolViDATDD100DocumentLineBuilder implements IBuilder <DocumentLineType>
{
  ...
  {
    final PeppolViDATDD100ItemBuilder aBuilder = new PeppolViDATDD100ItemBuilder ();
    aBuilderConsumer.accept (aBuilder);
