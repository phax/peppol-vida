...
/**
 * Builder for Peppol ViDA pilot TDD 1.1.0 sub element called "PaymentMeans".
 *
 * @author Philip Helger
 */
public class PeppolViDATDD110PaymentMeansBuilder implements IBuilder <PaymentMeansType>
{
  private static final Logger LOGGER = LoggerFactory.getLogger (PeppolViDATDD110PaymentMeansBuilder.class);
  ...
  public PeppolViDATDD110PaymentMeansBuilder ()
  {}
   ...
   */
  @NonNull
  public PeppolViDATDD110PaymentMeansBuilder initFromUBL (@NonNull final PaymentMeansType aObj)
  {
  ...
  @NonNull
  public PeppolViDATDD110PaymentMeansBuilder paymentMeansCode (@Nullable final String s)
  {
  ...
  @NonNull
  public PeppolViDATDD110PaymentMeansBuilder paymentMeansCodeName (@Nullable final String s)
  {
  ...
  @NonNull
  public PeppolViDATDD110PaymentMeansBuilder paymentID (@Nullable final String s)
  {
    m_sPaymentID = s;
    return this;
  }
  ...
  @NonNull
  public PeppolViDATDD110PaymentMeansBuilder cardPrimaryAccountNumberID (@Nullable final String s)
  {
  ...
  @NonNull
  public PeppolViDATDD110PaymentMeansBuilder cardNetworkID (@Nullable final String s)
  {
    m_sCardNetworkID = s;
    return this;
  }
  ...
  @NonNull
  public PeppolViDATDD110PaymentMeansBuilder cardHolderName (@Nullable final String s)
  {
    m_sCardHolderName = s;
    return this;
  }
  ...
  @NonNull
  public PeppolViDATDD110PaymentMeansBuilder payeeFinancialAccountID (@Nullable final String s)
  {
  ...
  @NonNull
  public PeppolViDATDD110PaymentMeansBuilder payeeFinancialAccountIDScheme (@Nullable final String s)
  {
  ...
  @NonNull
  public PeppolViDATDD110PaymentMeansBuilder payeeFinancialInstitutionBranchID (@Nullable final String s)
  {
  ...
  @NonNull
  public PeppolViDATDD110PaymentMeansBuilder payeeFinancialInstitutionBranchIDScheme (@Nullable final String s)
  {
  ...
  private boolean _isEveryRequiredFieldSet (final boolean bDoLogOnError, @NonNull final MutableInt aErrorCount)
  {
    ...
    final String sErrorPrefix = "Error in Peppol ViDA pilot TDD 1.1.0 PaymentMeans builder: ";
