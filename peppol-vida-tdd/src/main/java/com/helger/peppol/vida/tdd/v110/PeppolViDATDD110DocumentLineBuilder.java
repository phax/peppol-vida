...
/**
 * Builder for Peppol ViDA pilot TDD 1.1.0 sub element called "DocumentLine".
 *
 * @author Philip Helger
 */
public class PeppolViDATDD110DocumentLineBuilder implements IBuilder <DocumentLineType>
{
  private static final Logger LOGGER = LoggerFactory.getLogger (PeppolViDATDD110DocumentLineBuilder.class);
  ...
  public PeppolViDATDD110DocumentLineBuilder (@Nullable final String sDocumentCurrencyCode)
  {
   ...
   */
  @NonNull
  public PeppolViDATDD110DocumentLineBuilder initFromInvoice (@NonNull final InvoiceLineType aLine)
  {
   ...
   */
  @NonNull
  public PeppolViDATDD110DocumentLineBuilder initFromCreditNote (@NonNull final CreditNoteLineType aLine)
  {
  ...
  @NonNull
  public PeppolViDATDD110DocumentLineBuilder id (@Nullable final String s)
  {
    m_sID = s;
    return this;
  }
  ...
  @NonNull
  public PeppolViDATDD110DocumentLineBuilder note (@Nullable final String s)
  {
    m_sNote = s;
    return this;
  }
  ...
  @NonNull
  public PeppolViDATDD110DocumentLineBuilder quantity (@Nullable final BigDecimal a)
  {
    m_aQuantity = a;
    return this;
  }
  ...
  @NonNull
  public PeppolViDATDD110DocumentLineBuilder quantity (final long n)
  {
  ...
  @NonNull
  public PeppolViDATDD110DocumentLineBuilder quantityUnit (@Nullable final String s)
  {
    m_sQuantityUnit = s;
    return this;
  }
  ...
  @NonNull
  public PeppolViDATDD110DocumentLineBuilder lineExtensionAmount (@Nullable final BigDecimal a)
  {
  ...
  @NonNull
  public PeppolViDATDD110DocumentLineBuilder lineExtensionAmount (final long n)
  {
  ...
  @NonNull
  public PeppolViDATDD110DocumentLineBuilder invoicePeriodStart (@Nullable final LocalDate a)
  {
  ...
  @NonNull
  public PeppolViDATDD110DocumentLineBuilder invoicePeriodEnd (@Nullable final LocalDate a)
  {
  ...
  @NonNull
  public PeppolViDATDD110DocumentLineBuilder invoicePeriodDescriptionCode (@Nullable final String s)
  {
  ...
  @NonNull
  public PeppolViDATDD110DocumentLineBuilder allowanceCharges (@Nullable final ICommonsList <AllowanceChargeType> a)
  {
  ...
  @NonNull
  public PeppolViDATDD110DocumentLineBuilder addAllowanceCharge (@Nullable final AllowanceChargeType a)
  {
    if (a != null)
  ...
  @NonNull
  public PeppolViDATDD110DocumentLineBuilder addAllowanceCharge (@Nullable final PeppolViDATDD110AllowanceChargeBuilder a)
  {
    return addAllowanceCharge (a == null ? null : a.build ());
  }

  @NonNull
  public PeppolViDATDD110DocumentLineBuilder addAllowanceCharge (@NonNull final Consumer <PeppolViDATDD110AllowanceChargeBuilder> aBuilderConsumer)
  {
  ...
  @NonNull
  public PeppolViDATDD110DocumentLineBuilder item (@Nullable final ItemType a)
  {
    m_aItem = a;
    return this;
  }
  ...
  @NonNull
  public PeppolViDATDD110DocumentLineBuilder item (@Nullable final PeppolViDATDD110ItemBuilder a)
  {
    return item (a == null ? null : a.build ());
  }

  @NonNull
  public PeppolViDATDD110DocumentLineBuilder item (@NonNull final Consumer <PeppolViDATDD110ItemBuilder> aBuilderConsumer)
  {
    final PeppolViDATDD110ItemBuilder aBuilder = new PeppolViDATDD110ItemBuilder ();
    aBuilderConsumer.accept (aBuilder);
  ...
  @NonNull
  public PeppolViDATDD110DocumentLineBuilder priceAmount (@Nullable final BigDecimal a)
  {
    m_aPriceAmount = a;
    return this;
  }
  ...
  @NonNull
  public PeppolViDATDD110DocumentLineBuilder priceAmount (final long n)
  {
  ...
  @NonNull
  public PeppolViDATDD110DocumentLineBuilder priceBaseQuantity (final long n)
  {
    return priceBaseQuantity (BigHelper.toBigDecimal (n));
  }

  @NonNull
  public PeppolViDATDD110DocumentLineBuilder priceBaseQuantity (@Nullable final BigDecimal a)
  {
  ...
  private boolean _isEveryRequiredFieldSet (final boolean bDoLogOnError, @NonNull final MutableInt aErrorCount)
  {
    ...
    final String sErrorPrefix = "Error in Peppol ViDA pilot TDD 1.1.0 DocumentLine builder: ";
