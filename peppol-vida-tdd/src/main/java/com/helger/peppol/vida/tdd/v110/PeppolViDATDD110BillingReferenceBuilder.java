...
/**
 * Builder for Peppol ViDA pilot TDD 1.1.0 sub element called "BillingReference".
 *
 * @author Philip Helger
 */
public class PeppolViDATDD110BillingReferenceBuilder implements IBuilder <BillingReferenceType>
{
  private static final Logger LOGGER = LoggerFactory.getLogger (PeppolViDATDD110BillingReferenceBuilder.class);

  private String m_sID;
  private String m_sIDScheme;
  private LocalDate m_aIssueDate;

  public PeppolViDATDD110BillingReferenceBuilder ()
  {}
   ...
   */
  @NonNull
  public PeppolViDATDD110BillingReferenceBuilder initFromUBL (@NonNull final BillingReferenceType aObj)
  {
  ...
  @NonNull
  public PeppolViDATDD110BillingReferenceBuilder id (@Nullable final String s)
  {
    m_sID = s;
    return this;
  }
  ...
  @NonNull
  public PeppolViDATDD110BillingReferenceBuilder idScheme (@Nullable final String s)
  {
    m_sIDScheme = s;
    return this;
  }
  ...
  @NonNull
  public PeppolViDATDD110BillingReferenceBuilder issueDate (@Nullable final LocalDate a)
  {
    m_aIssueDate = a;
    return this;
  }
  ...
  private boolean _isEveryRequiredFieldSet (final boolean bDoLogOnError, @NonNull final MutableInt aErrorCount)
  {
    ...
    final String sErrorPrefix = "Error in Peppol ViDA pilot TDD 1.1.0 BillingReference builder: ";
